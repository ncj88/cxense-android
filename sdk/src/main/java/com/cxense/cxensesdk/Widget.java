...
/**
 * Widget class that is used to fetch items from the Cxense Content service for the specified {@link ContentUser} and
 * {@link WidgetContext}.
 *
...
public final class Widget {
    ...
    /**
     * Fetch async a list of {@link com.cxense.cxensesdk.model.WidgetItem items} for the given {@link WidgetContext} and
     * {@link ContentUser}
     *
     * @param widgetContext the WidgetContext
    ...
    public void loadItemsAsync(final WidgetContext widgetContext, ContentUser user,
